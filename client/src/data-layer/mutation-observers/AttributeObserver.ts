/**
 * This is a replica of Stimulus's AttributeObserver
 * https://github.com/hotwired/stimulus/tree/main/src/mutation-observers
 *
 * @see ElementObserver for a description of the stack
 */

import { ElementObserver, ElementObserverDelegate } from "./ElementObserver";
